              ...
              <View style={estilos.modalPicker}>
                <Picker
                  ...
                  onValueChange={novaCategoria => setCategoria(novaCategoria)}>
                    <Picker.Item label="MatrizCast" value="MatrizCast"/>
                    <Picker.Item label="MatrizKIDS" value="MatrizKIDS"/>
                    <Picker.Item label="Matriz4YOU" value="Matriz4YOU"/>
                </Picker>
              </View>
